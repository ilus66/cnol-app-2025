...
async function drawBadgeTopLeft(page, pdfDoc, userData) {
    ...
    page.drawText(title1, { x: centerX + 5, y: y + 7, size: 20, font: fontBold, color: rgb(0,0,0) });
    y -= 26;
    page.drawText(title2, { x: centerX + 5, y: y + 7, size: 20, font: fontBold, color: rgb(0,0,0) });
    y -= 20;
    // 3. Adresse
    ...
    y -= 75;
    page.drawText("BADGE nominatif personnel – Présentez-le à l'entrée", { x: decalX, y: y, size: 7, font: fontRegular, color: rgb(0.2,0.2,0.2) });
    y -= 29;
