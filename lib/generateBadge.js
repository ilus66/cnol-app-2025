...
async function generateBadge(userData) {
    try {
        ...
        if (userData.identifiant_badge) {
            // Label
            page.drawText('N° d\'identification', {
                x: 20,
                y: infoY + 410, // même niveau vertical que le QR code (y: infoY + 320 + 100 = 420)
                size: 10,
                font: fontBold,
                color: rgb(0, 0, 0),
            });
            ...
            page.drawText(userData.identifiant_badge, {
                x: 35, y: infoY + 390, size: 20, font: fontBold, color: rgb(0, 0, 0)
            });
        }
