// Script de backfill V3 pour statistiques_participants
// Version corrigée sans la colonne statut qui n'existe pas
...
async function syncAllV3() {
  console.log('🚀 Début de la synchro V3 statistiques_participants\n');
